...
//   // Handle the case where getTables returns an object with success/error structure
//   let tables: Array<{ id: string; number: number; capacity: number; location: string }> = []
  
//   if ('success' in tablesResult && tablesResult.success && tablesResult.data) {
//     // Extract just the table data, removing reservations
